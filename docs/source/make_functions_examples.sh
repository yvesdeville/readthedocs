...
# > sudo apt install python3-sphinx-code-include python3-sphinx-rst-builder python3-myst-parser python3-sphinx-rtd-theme
...
for f in `ls functions`; do
    ...
    echo "library(rlibkriging, lib.loc='../../../libKriging/bindings/R/Rlibs')" > /tmp/$f.R
