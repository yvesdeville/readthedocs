...
\begin{document}
    ...
    \begin{tikzpicture}
      ...
      {$\m{X}_{\texttt{u}}$};
      \node[draw=Orange, very thick, dashed, fill=orange!20,
      minimum width=1.6em, minimum height=4.5em ] at (1.6, 0)
      {$\m{y}_{\texttt{u}}$};

      \node[draw=Orange, very thick, fill=orange!20,
      minimum width=5em, minimum height=4.5em] at (3.4, 0)
      {$\m{Y}^{\textsf{sim}}_{\texttt{u}}$};
      
      \node[draw=MonVert, very thick, fill=MonVert!20,
      minimum width=4em, minimum height=4.5em ] at (0, -2.1)
      {$\m{X}_{\texttt{n}}$};
      \node[draw=MonVert, very thick, dashed, fill=MonVert!20,
      minimum width=1.6em, minimum height=4.5em ] at (1.6, -2.1)
      {$\m{y}_{\texttt{n}}$};
      \node[draw=MonVert, very thick, fill=MonVert!20,
      minimum width=5em, minimum height=4.5em] at (3.4, -2.1)
